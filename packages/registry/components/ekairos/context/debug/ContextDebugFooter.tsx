...
import { useContextDebugSnapshots } from "./registry";
...
const DOCK_STORAGE_KEY = "esolbay.context-debug-footer.dock";
...
export function ContextDebugFooter() {
  const [open, setOpen] = useState(false);
  const snapshots = useContextDebugSnapshots();
